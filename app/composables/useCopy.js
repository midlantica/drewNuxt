// composables/useCopy.js
// Static site copy — no Pinia needed, plain composable is sufficient.
export function useCopy() {
  return {
    ...
    resumeWord: '/resume/Drew_Harper_Resume_2026.docx',
    resumePDF: '/resume/Drew_Harper_Resume_2026.pdf',
