...
<template>
  ...
  >
    <div class="flagBox">
      <div
        class="bg-[url( flag h-[60px] w-[100px] block justify-center content-center items-center self-center mr-4 bg-no-repeat'/img/brit_amer_flag.svg')] bg-center bg-contain"
      >
        &nbsp;
      </div>
    </div>
...
const { play: playYeehaw } = useSound(yeehawSound, { volume: 0.75 })
const { play: playJollyGood } = useSound(jollyGoodSound, { volume: 0.75 })
